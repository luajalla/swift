...
type ProvidedMethod(methodName: string, parameters: ProvidedParameter list, returnType: Type, ?methodAttributes: MethodAttributes) =
    ...
    let mutable methodAttrs   = match methodAttributes with 
